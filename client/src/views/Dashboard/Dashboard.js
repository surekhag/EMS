...
const Dashboard = props => {
    ...
    const handleChange = e => {
        ...
        } else setMultipleStatesName(e.target.value)
    }
            ...
            <div>
                <GridContainer>
                    ...
                    <GridItem xs={12} sm={12} md={6}>
                        <Accordion
                            panelHeading="Allowcated Projects"
                            panelData={
                                <Table
                    ...
                    <GridItem xs={12} sm={12} md={12}>
                        <Accordion
                            panelHeading="Attendence Log"
                            panelData={
                                <>
                                    <InputLabel>
                                        Current Week Attendence
                                    </InputLabel>
                                    <Table
                                        tableHeaderColor="gray"
                                        tableHead={[
                    ...
                    <GridItem xs={12} sm={12} md={6}>
                        <FormControl>
                            ...
                            >
                                ...
                                {selectedState
                                    ? StatesData.data[selectedState].map(
                                          (prop, key) => {
                                              return (
                                                  <MenuItem
                                                      value={prop}
                    ...
                    <GridItem xs={12} sm={12} md={6}>
                        <FormControl>
                            ...
                            >
                                {StatesData
                                    ? Object.keys(StatesData.data).map(name => (
